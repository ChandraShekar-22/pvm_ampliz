...
export class OverviewComponent implements OnInit {
  ...
  getExecutives() {
    this.imagingService
      .getExecutivesOfImagingCenter(this.paramsData, 0, 200)
      .subscribe(
        (res) => {
  ...
  getImaginCenterDetails() {
    this.imagingService
      .imagingGetImagingCenterDetails(this.paramsData)
      .subscribe(
        (res) => {
          this.loaderService.display(false);
  ...
  getImagingCenterOverviewData() {
    this.imagingService
      .getOverviewOfImagingCenter(this.paramsData)
      .subscribe((res) => {
  ...
  // }
  get saveButtonText() {
    return this.imagingCenterDetails.leadSaveStatus == "NotSaved"
      ? "View"
      : "Save";
  }
  viewImagingCenterFromList() {
    ...
    this.imagingService.viewImagingFromList(body).subscribe(
      (res) => {
        ...
        this.imagingService
          .getImagingCenterDetails(this.imagingCenterDetails.icExecutiveId)
          .subscribe(
            (overview) => {
