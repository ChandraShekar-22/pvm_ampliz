...
export class HealthcareonboardComponent implements OnInit {
  constructor(private router: Router, private cookieService: CookieService, private amplizService: AmplizService) {}
  subscriptions = [];
  chromeData = {};
  currentCredit = 0;
  creditsremaining = 0;
  ...
  newLaunchUpdates: any[] = [
    {
      ...
      options: ['Assisted leaving', 'Home healthcare', 'Hospices', 'Retirement communities', 'Nursing home'],
      navigate: 'ltc',
    },
    {
      ...
      options: ['Patient demographics', 'Network affiliations', 'Technology installations', 'Procedure volumes'],
      navigate: 'imaging',
    },
  ];
