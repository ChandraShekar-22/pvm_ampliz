...
@Component({
	selector: 'app-hscpc-details',
	templateUrl: './hscpc-details.component.html',
	styleUrls: ['./hscpc-details.component.css']
})
export class HscpcDetailsComponent implements OnInit {
