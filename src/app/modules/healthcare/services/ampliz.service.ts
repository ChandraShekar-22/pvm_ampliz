...
export class AmplizService {
	...
	deleteAllCookies() {
		...
		for (let i = 0; i < cookies.length; i++) {
			...
			if (
				...
				document.cookie = name + '=;expires=Thu, 01 Jan 1970 00:00:01 GMT; path=/; domain=.' + this.domainName
			}
		}
	}
	...
	getExecutiveDetailsUnmasked(healthExeId: string): Observable<any> {
		const url = environment.prodHcApi + '/amplizhcreadapi/search/get-health-executive-detail-unmasked'
	...
	reportIncorrectExecutiveData(executiveId: any, incorrectDataList: []): Observable<any> {
		const url = environment.prodHcApi + '/amplizhcwriteapi/customervoice/report-incorrect-executive-data'
		const body = {
			healthExecutiveId: executiveId,
			incorrectDataList: incorrectDataList,
		}
	...
	reportIncorrectHospitalData(hospitalId, incorrectDataList: []): Observable<any> {
		const url = environment.prodHcApi + '/amplizhcwriteapi/customervoice/report-incorrect-hospital-data'
		const body = {
	...
	getHospitalSpecification(hospitalId: any): Observable<any> {
		const url = environment.prodHcApi + '/amplizhcreadapi/hospitaloverview/get-hospital-specification'
		const body = { hospitalId: hospitalId }
		const response = this.http.get(url, { params: body })
		return response
	}
	...
	getHospitalFinacialEarning(hospitalId: any): Observable<any> {
		const url = environment.prodHcApi + '/amplizhcreadapi/hospitaloverview/get-hospital-financial-earnings'
		const body = { hospitalId: hospitalId }
		const response = this.http.get(url, { params: body })
		return response
	}
	...
	getHospitalFinancialCostandBudget(hospitalId: any): Observable<any> {
		const url =
			environment.prodHcApi + '/amplizhcreadapi/hospitaloverview/get-hospital-financial-cost-and-budget'
		const body = { hospitalId: hospitalId }
		const response = this.http.get(url, { params: body })
		return response
	}
	...
	getHospitalFinancialIncomeandEbitda(hospitalId: any): Observable<any> {
		const url =
			environment.prodHcApi + '/amplizhcreadapi/hospitaloverview/get-hospital-financial-income-and-e-b-i-t-d-a'
		const body = { hospitalId: hospitalId }
		const response = this.http.get(url, { params: body })
		return response
	}
	...
	getHospitalFinancialAssets(hospitalId: any): Observable<any> {
		const url = environment.prodHcApi + '/amplizhcreadapi/hospitaloverview/get-hospital-financial-assets'
		const body = { hospitalId: hospitalId }
		const response = this.http.get(url, { params: body })
		return response
	}
	...
	getHospitalFinancialLiabilities(hospitalId: any): Observable<any> {
		const url = environment.prodHcApi + '/amplizhcreadapi/hospitaloverview/get-hospital-financial-liabilities'
		const body = { hospitalId: hospitalId }
		const response = this.http.get(url, { params: body })
		return response
	}
	...
	getPhysicianPrescriberDrugDetail(physicianId: any): Observable<any> {
		const url = environment.prodHcApi + '/amplizhcreadapi/search/get-physician-prescriber-drug-detail'
		const body = { physicianId: physicianId }
		const response = this.http.get(url, { params: body })
		return response
	}
	...
	getSpecialityListForSpecialityUser(params: any): Observable<any> {
		const url =
			environment.prodHcApi + '/amplizhcreadapi/general/get-speciality-all-auto-suggest-for-speciality-user'
		// const body = { searchPhase: searchPhase };
		const response = this.http.post(url, params)
		return response
	}
	...
	getPhysicianPractiseHospital(physicianId: string): Observable<any> {
		const url = environment.prodHcApi + '/amplizhcreadapi/search/get-physician-practise-hospitals'
		const response = this.http.get(url, { params: { physicianId } })
		return response
	}
	getPhysicianAffiliatedHospital(physicianId: string): Observable<any> {
		const url = environment.prodHcApi + '/amplizhcreadapi/search/get-physician-affiliated-hospitals'
		const response = this.http.get(url, { params: { physicianId } })
		return response
	}
	getSmiliarPhysician({ physicianId, speciality }: any): Observable<any> {
		const url = environment.prodHcApi + '/amplizhcreadapi/search/similar-physicians'
		const response = this.http.get(url, { params: { physicianId, speciality } })
		return response
	}
}
