...
export class AmplizService {
  ...
  getSearchData(body: any): Observable<any> {
    ...
    const url =
      environment.prodHcApi + "/amplizhcreadapi/search/search-summary";
  ...
  deleteList(listId: any): Observable<any> {
    const url =
      environment.prodHcApi + "/amplizhcwriteapi/savedlist/delete-list";
  ...
  searchPhysician(parameter: SearchPhysicianModel): Observable<any> {
    const url =
      environment.prodHcApi + "/amplizhcreadapi/search/search-physician";
  ...
  searchPhysicianForSpeciality(data: SearchPhysicianModel): Observable<any> {
    const url =
      ...
      "/amplizhcreadapi/user/search-physician-for-speciality-user";
    // console.log(parameter, data);
    const bodyN = {
      serachInput: data,
    };
  ...
  getSpecialityUsersExportCsv(data: SearchPhysicianModel): Observable<any> {
    ...
    const url =
      environment.prodHcApi +
      "/amplizhcreadapi/user/get-speciality-users-export-csv";
    // console.log(url);
    const headers = new HttpHeaders({
      Authorization: "Bearer " + authToken,
      responseType: "blob",
  ...
  getStateList(parameter: any): Observable<any> {
    const url =
      environment.prodHcApi + "/amplizhcreadapi/general/get-state-list";
    const body = parameter;
    const response = this.http.get(url, { params: body });
    return response;
  }
  getCitylList(parameter: any): Observable<any> {
    const url =
      environment.prodHcApi +
      "/amplizhcreadapi/general/get-city-list-for-state";
    const body = parameter;
    const response = this.http.get(url, { params: body });
    return response;
  }
  getHospitalList(parameter: any) {
    const url =
      environment.prodHcApi + "/amplizhcreadapi/general/get-hospital-list";
    const body = parameter;
    ...
    return this.hospitals.length
      ...
      : this.http
          .get(url, { params: body })
          .pipe(tap((data) => (this.hospitals = data)));
    // return response;
  }
  getHospitalTypeList(parameter: any): Observable<any> {
    const url =
      environment.prodHcApi + "/amplizhcreadapi/general/get-hospital-type-list";
    const body = parameter;
    const response = this.http.get(url, { params: body });
    return response;
  }
  ...
  getTitleList(parameter: any): Observable<any> {
    const url =
      environment.prodHcApi + "/amplizhcreadapi/general/get-title-list";
    const body = parameter;
    const response = this.http.get(url, { params: body });
    return response;
  }
  ...
  searchExecutive(parameter: any, data?: any): Observable<any> {
    const url =
      environment.prodHcApi + "/amplizhcreadapi/search/search-health-executive";
  ...
  physicianOverviewDetails(physicianId: string): Observable<any> {
    const url =
      environment.prodHcApi + "/amplizhcreadapi/search/get-physician-detail";
  ...
  getPhysicianDetailsUnmasked(physicianId: string): Observable<any> {
    const url =
      environment.prodHcApi +
      "/amplizhcreadapi/search/get-physician-detail-unmasked";
    const body = { physicianId: physicianId };
    const response = this.http.get(url, { params: body });
    return response;
  }
  ...
  executiveOverviewDetails(executiveId: string): Observable<any> {
    const url =
      environment.prodHcApi +
      "/amplizhcreadapi/search/get-health-executive-detail";
  ...
  getExecutiveDetailsUnmasked(healthExeId: string): Observable<any> {
    const url =
      environment.prodHcApi +
      "/amplizhcreadapi/search/get-health-executive-detail-unmasked";
  ...
  hospitalOverviewDetails(hospitalId: string): Observable<any> {
    const url =
      environment.prodHcApi + "/amplizhcreadapi/search/get-hospital-detail";
  ...
  searchHospital(parameter: any, body: any): Observable<any> {
    const url =
      environment.prodHcApi + "/amplizhcreadapi/search/search-hospital";
    const params = parameter;
  ...
  viewPhysicianFromList(physicianId: any, listId: any): Observable<any> {
    const url =
      environment.prodHcApi +
      "/amplizhcwriteapi/savedlist/add-physician-to-list";
  ...
  viewExecutiveFromList(executiveId: any, listId: any): Observable<any> {
    const url =
      environment.prodHcApi +
      "/amplizhcwriteapi/savedlist/add-health-executive-to-list";
  ...
  reportIncorrectPhysicianData(
    ...
    const url =
      environment.prodHcApi +
      "/amplizhcwriteapi/customervoice/report-incorrect-physician-data";
    const body = {
  ...
  reportIncorrectExecutiveData(
    ...
    const url =
      environment.prodHcApi +
      "/amplizhcwriteapi/customervoice/report-incorrect-executive-data";
    const body = {
  ...
  reportIncorrectHospitalData(
    ...
    const url =
      environment.prodHcApi +
      "/amplizhcwriteapi/customervoice/report-incorrect-hospital-data";
    const body = {
  ...
  saveLeadName(listId: string, listName: string) {
    const url =
      environment.prodHcApi + "/amplizhcwriteapi/savedlist/edit-list-name";
  ...
  removeDataFromList(listId: string, leadIdList: any): Observable<any> {
    const url =
      environment.prodHcApi +
      "/amplizhcwriteapi/savedlist/remove-data-from-list";
  ...
  downloadExcel(listId: any, leadsIdList: []): Observable<any> {
    ...
    const url =
      environment.prodHcApi + "/amplizhcreadapi/list/export-selected-list";
    const response = this.http.post(url, body, {
      headers: headers,
      observe: "response",
      responseType: "blob",
  ...
  getHospitalSpecification(hospitalId: any): Observable<any> {
    const url =
      environment.prodHcApi +
      "/amplizhcreadapi/hospitaloverview/get-hospital-specification";
    const body = { hospitalId: hospitalId };
    const response = this.http.get(url, { params: body });
    return response;
  }
  ...
  getHospitalEarning(hospitalId: any): Observable<any> {
    const url =
      environment.prodHcApi +
      "/amplizhcreadapi/hospitaloverview/get-hospital-earnings";
    const body = { hospitalId: hospitalId };
    const response = this.http.get(url, { params: body });
    return response;
  }
  ...
  getHospitalStats(hospitalId: any): Observable<any> {
    const url =
      environment.prodHcApi +
      "/amplizhcreadapi/hospitaloverview/get-hospital-stats";
    const body = { hospitalId: hospitalId };
    const response = this.http.get(url, { params: body });
    return response;
  }
  ...
  getTotalStats(hospitalId: any): Observable<any> {
    const url =
      environment.prodHcApi +
      "/amplizhcreadapi/hospitaloverview/get-total-stats";
    const body = { hospitalId: hospitalId };
    const response = this.http.get(url, { params: body });
    return response;
  }
  ...
  getHospitalFinacialEarning(hospitalId: any): Observable<any> {
    const url =
      environment.prodHcApi +
      "/amplizhcreadapi/hospitaloverview/get-hospital-financial-earnings";
    const body = { hospitalId: hospitalId };
    const response = this.http.get(url, { params: body });
    return response;
  }
  ...
  getHospitalFinancialAssets(hospitalId: any): Observable<any> {
    const url =
      environment.prodHcApi +
      "/amplizhcreadapi/hospitaloverview/get-hospital-financial-assets";
    const body = { hospitalId: hospitalId };
    const response = this.http.get(url, { params: body });
    return response;
  }
  ...
  getHospitalFinancialLiabilities(hospitalId: any): Observable<any> {
    const url =
      environment.prodHcApi +
      "/amplizhcreadapi/hospitaloverview/get-hospital-financial-liabilities";
    const body = { hospitalId: hospitalId };
    const response = this.http.get(url, { params: body });
    return response;
  }
  ...
  getPhysicianPrescriberDrugDetail(physicianId: any): Observable<any> {
    const url =
      environment.prodHcApi +
      "/amplizhcreadapi/search/get-physician-prescriber-drug-detail";
    const body = { physicianId: physicianId };
    const response = this.http.get(url, { params: body });
    return response;
  }
  ...
  getNPINumberList(params: any): Observable<any> {
    const url =
      environment.prodHcApi + "/amplizhcreadapi/general/get-npi-number-list";
  ...
  getNumberOfBedList(params: any): Observable<any> {
    const url =
      environment.prodHcApi + "/amplizhcreadapi/general/get-bed-range-list";
    const response = this.http.get(url, { params: params });
    return response;
  }
  getSpecialityList(params: any): Observable<any> {
    const url =
      environment.prodHcApi +
      "/amplizhcreadapi/general/get-speciality-all-auto-suggest";
    // const body = { searchPhase: searchPhase };
  ...
  getSpecialitySuggestion(params: any): Observable<any> {
    const url =
      environment.prodHcApi +
      "/amplizhcreadapi/general/get-speciality-related-term";
    // const body = { searchPhase: searchPhase };
    const response = this.http.post(url, params);
    return response;
  }
  ...
  generateApiKey(): Observable<any> {
    const url =
      environment.prodHcApi + "/amplizhcwriteapi/enterprize/generate-api-key";
    const params = {};
    const response = this.http.post(url, {});
    return response;
  }
  ...
  getSavedApiKey(): Observable<any> {
    const url =
      environment.prodHcApi +
      "/amplizhcreadapi/enterprize/get-api-key-for-user";
    const response = this.http.get(url);
    return response;
  }
  getPhysicianListForHospital(params: any): Observable<any> {
    ...
    const url =
      environment.prodHcApi +
      "/amplizhcreadapi/search/get-physician-list-for-hospital";
    const response = this.http.get(url, { params: body });
    return response;
  }
  ...
  getExecutiveListForHospital(params: any): Observable<any> {
    ...
    const url =
      environment.prodHcApi +
      "/amplizhcreadapi/search/get-executive-list-for-hospital";
    const response = this.http.get(url, { params: body });
    return response;
  }
  ...
  getPhysicianNetNewCount(data: SearchPhysicianModel): Observable<any> {
    const url =
      environment.prodHcApi +
      "/amplizhcreadapi/search/get-physician-net-new-count";
  ...
  getExecutiveNetNewCount(params: any, data?: any): Observable<any> {
    const url =
      environment.prodHcApi +
      "/amplizhcreadapi/search/get-health-executive-net-new-count";
    const body = params;
  ...
  requestSpecialitySearch(data: any) {
    const url =
      environment.prodHcApi +
      "/amplizhcwriteapi/user/request-speciality-access";
    const response = this.http.post(url, data);
    return response;
  }
  requestSpecialitySearchEx(data: any) {
    const url =
      environment.prodHcApi + "/amplizhcwriteapi/user/request-executive-access";
    const response = this.http.post(url, data);
    return response;
  }
  ...
  savePhysicianAsPerCount(data: any): Observable<any> {
    const url =
      environment.prodHcApi +
      "/amplizhcwriteapi/savedlist/save-physician-records-as-per-count";
    const response = this.http.post(url, data);
    return response;
  }
  ...
  saveExecutiveAsPerCount(data: any): Observable<any> {
    const url =
      environment.prodHcApi +
      "/amplizhcwriteapi/savedlist/save-executive-records-as-per-count";
    const response = this.http.post(url, data);
    return response;
  }
  ...
  allocateOneTimeCredit(body) {
    const url =
      environment.prodAdbApi +
      "/ADB/api/allocate-one-time-credit-to-team-member";
    const response = this.http.post(url, body);
    return response;
  }
  ...
  allocateReccuringCredit(body) {
    const url =
      environment.prodAdbApi +
      "/ADB/api/allocate-recurring-credit-to-team-member";
    const response = this.http.post(url, body);
    return response;
  }
  ...
  regenerateVerificationCode(body) {
    ...
    const url =
      environment.prodAdbApi + "/ADB/api/regenerate-verification-code";
    const response = this.http.post(url, body);
    return response;
  }
}
